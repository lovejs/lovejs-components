const { Definitions: { Arguments, Call, Service, Tag }, errors } = require("components/di");
const { DiServiceError } = errors;

const service = new Service("module");

test("Create instance of Service and getModule", () => {
    expect(service).toBeInstanceOf(Service);
    expect(service.getModule()).toBe("module");
});

test("Getter, Setter and fluent api on setters", () => {
...
test("addTag, getTag, getTags, setTags", () => {
...
test("addCall, hasCalls, getCalls, setCalls", () => {
